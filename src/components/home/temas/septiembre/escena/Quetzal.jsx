 ...
 * de su cuerpo y mira siempre hacia la izquierda. La animación
 * `sep-quetzal-vuelo` traslada ese origen sobre la curva del circuito, así que
 * aquí sólo importa la anatomía, no la posición.
 *
...
export default function Quetzal({ uid }) {
  return (
    <g className="sepQuetzal__vuelo">
      ...
      {/* El escalado vive aquí y no en la trayectoria: los keyframes trasladan
          el origen en coordenadas de escena y no deben tocar el tamaño. */}
