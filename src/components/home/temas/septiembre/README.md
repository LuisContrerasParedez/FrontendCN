...
├─ ListonBandera.jsx          franja ondulada inferior + bandera
├─ Escudo.jsx                 escudo dibujado (respaldo si falla la imagen)
├─ iconos.jsx                 calendario, bus, flecha
├─ quetzal.keyframes.js       generador de la trayectoria y del aleteo
├─ index.js
└─ escena/
...
- **Sin bandera flotante.** La única bandera vive integrada en el listón, con
  colas doradas que la anclan a la franja en vez de dejarla suelta.
